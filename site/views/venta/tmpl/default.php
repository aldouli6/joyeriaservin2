...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo JText::_('COM_SERVIN2_FORM_LBL_VENTA_TOTAL'); ?></th>
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	...
	<a class="btn" href="<?php echo JRoute::_('index.php?option=com_servin2&task=venta.edit&id='.$this->item->id); ?>"><?php echo JText::_("COM_SERVIN2_EDIT_ITEM"); ?></a>

<?php endif; ?>

<?php if (JFactory::getUser()->authorise('core.delete','com_servin2.venta.'.$this->item->id)) : ?>
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a href="<?php echo JRoute::_('index.php?option=com_servin2&task=venta.remove&id=' . $this->item->id, false, 2); ?>" class="btn btn-danger">
				<?php echo JText::_('COM_SERVIN2_DELETE_ITEM'); ?>
			</a>
		</div>
	</div>
