...
<div class="kilataje-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-kilataje"
			  action="<?php echo JRoute::_('index.php?option=com_servin2&task=kilataje.save'); ?>"
	...
	<?php echo $this->form->renderField('kilataje'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin2&task=kilatajeform.cancel'); ?>"
