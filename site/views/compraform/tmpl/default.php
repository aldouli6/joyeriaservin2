...
<div class="compra-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-compra"
			  action="<?php echo JRoute::_('index.php?option=com_servin2&task=compra.save'); ?>"
	...
	<?php echo $this->form->renderField('pagada'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin2&task=compraform.cancel'); ?>"
