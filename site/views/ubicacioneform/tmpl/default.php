...
<div class="ubicacione-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-ubicacione"
			  action="<?php echo JRoute::_('index.php?option=com_servin2&task=ubicacione.save'); ?>"
	...
	<?php echo $this->form->renderField('direccion'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin2&task=ubicacioneform.cancel'); ?>"
