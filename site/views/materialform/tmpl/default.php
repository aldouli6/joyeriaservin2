...
<div class="material-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-material"
			  action="<?php echo JRoute::_('index.php?option=com_servin2&task=material.save'); ?>"
	...
	<?php echo $this->form->renderField('nombre'); ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_servin2&task=materialform.cancel'); ?>"
