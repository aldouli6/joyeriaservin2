...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_servin2&task=ventas.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'ventaList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_servin2&view=ventas'); ?>" method="post"
