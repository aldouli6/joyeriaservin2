 ...
 * @since  1.6
 */
class Servin2ViewDashboards extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Servin2Helper::addSubmenu('dashboards');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN2_TITLE_DASHBOARDS'), 'dashboards.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin2&view=dashboards');
	}
