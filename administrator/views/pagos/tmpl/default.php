...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_servin2&task=pagos.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'pagoList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_servin2&view=pagos'); ?>" method="post"
			...
			<table class="table table-striped" id="pagoList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN2_PAGOS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN2_PAGOS_PAGO', 'a.`pago`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN2_PAGOS_METODO', 'a.`metodo`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_SERVIN2_PAGOS_FECHA', 'a.`fecha`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'pagos.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
