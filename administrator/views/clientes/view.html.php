 ...
 * @since  1.6
 */
class Servin2ViewClientes extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Servin2Helper::addSubmenu('clientes');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN2_TITLE_CLIENTES'), 'clientes.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_servin2&view=clientes');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`nombre`' => JText::_('COM_SERVIN2_CLIENTES_NOMBRE'),
			'a.`direccion`' => JText::_('COM_SERVIN2_CLIENTES_DIRECCION'),
			'a.`telefono`' => JText::_('COM_SERVIN2_CLIENTES_TELEFONO'),
			'a.`correo`' => JText::_('COM_SERVIN2_CLIENTES_CORREO'),
			'a.`fotoine`' => JText::_('COM_SERVIN2_CLIENTES_FOTOINE'),
			'a.`fotocomprobante`' => JText::_('COM_SERVIN2_CLIENTES_FOTOCOMPROBANTE'),
		);
	}
