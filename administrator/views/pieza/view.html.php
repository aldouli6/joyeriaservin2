 ...
 * @since  1.6
 */
class Servin2ViewPieza extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_SERVIN2_TITLE_PIEZA'), 'pieza.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_servin2.pieza', $this->item->id);
		}

		if (empty($this->item->id))
		{
			JToolBarHelper::cancel('pieza.cancel', 'JTOOLBAR_CANCEL');
		}
		else
		{
			JToolBarHelper::cancel('pieza.cancel', 'JTOOLBAR_CLOSE');
		}
	}
}
