 ...
 * @since  1.6
 */
class Servin2Tablecompra extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Servin2Tablecompra', array('typeAlias' => 'com_servin2.compra'));
		parent::__construct('#__servin_compras2', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin2.compra.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin2/access.xml',
				"/access/section[@name='compra']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin2.compra.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin2.compra.' . (int) $this->$k;
	}
