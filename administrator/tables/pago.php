 ...
 * @since  1.6
 */
class Servin2Tablepago extends JTable
{
	...
	public function bind($array, $ignore = '')
	{
		...
		{
			if (is_array($array['metodo']))
			{
				$array['metodo'] = implode(',',$array['metodo']);
			}
			elseif (strpos($array['metodo'], ',') != false)
			{
				$array['metodo'] = explode(',',$array['metodo']);
			}
			elseif (strlen($array['metodo']) == 0)
			{
				$array['metodo'] = '';
			}
		}
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin2.pago.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin2/access.xml',
				"/access/section[@name='pago']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin2.pago.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin2.pago.' . (int) $this->$k;
	}
