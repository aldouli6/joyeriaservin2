...
class Servin2Tableconsignacion extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Servin2Tableconsignacion', array('typeAlias' => 'com_servin2.consignacion'));
		parent::__construct('#__servin_consignaciones2', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin2.consignacion.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin2/access.xml',
				"/access/section[@name='consignacion']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin2.consignacion.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	public function check()
	{
		...
		if ($files['foto_pagare'][0]['size'] > 0)
		{
			...
			$oldFiles = Servin2Helper::getFiles($this->id, $this->_tbl, 'foto_pagare');
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin2.consignacion.' . (int) $this->$k;
	}
