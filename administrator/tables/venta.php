 ...
 * @since  1.6
 */
class Servin2Tableventa extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Servin2Tableventa', array('typeAlias' => 'com_servin2.venta'));
		parent::__construct('#__servin_ventas2', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_servin2.venta.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_servin2/access.xml',
				"/access/section[@name='venta']/"
			);
			$default_actions = JAccess::getAssetRules('com_servin2.venta.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_servin2.venta.' . (int) $this->$k;
	}
